...
((self) => {
  ...
  const run = (env, scriptContent, scriptUrl) => {
    ...
    scriptContent =
      `with(this){${
        scriptContent.replace(/\bthis\b/g, "(thi$(this)?window:this)").replace(
          /\/\/# so/g,
          "//Xso",
        )
  ...
  const getPartytownScript = () =>
    `<script src="${partytownLibUrl("partytown.js?v=0.7.2")}"><\/script>`;
              ...
              (() => {
                if (!webWorkerCtx.$initWindowMedia$) {
                  ...
                  webWorkerCtx.$importScripts$(
                    partytownLibUrl("partytown-media.js?v=0.7.2"),
                  );
